...
REM Environment setup for Java 23 compatibility
...
REM Force Java 23 compatibility for Gradle
set GRADLE_OPTS=-Dorg.gradle.java.home=E:\apps\java -Dorg.gradle.jvmargs=-Xmx4096m -Dfile.encoding=UTF-8 --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/java.io=ALL-UNNAMED
...
echo ========================================
echo Android Build Setup for Love & Roll (Java 23 Compatible)
echo ========================================
...
REM Update Gradle wrapper to version 8.13 for Java 23 compatibility
echo Updating Gradle wrapper to version 8.13...
if exist "platforms\android\gradle\wrapper\gradle-wrapper.properties" (
    ...
    echo OK: Gradle wrapper updated to 8.13
)

REM Setup Gradle with Java 23 compatible configuration
echo Setting up Gradle configuration for Java 23...
if exist "platforms\android" (
    ...
    (
        ...
        echo org.gradle.jvmargs=-Xmx4096m -Dfile.encoding=UTF-8 --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/java.io=ALL-UNNAMED --add-opens=java.base/java.net=ALL-UNNAMED
    ...
    echo Gradle configuration completed for Java 23
)
...
echo Building application with Java 23 compatibility...
...
echo ========================================
echo SUCCESS: Build completed with Java 23!
